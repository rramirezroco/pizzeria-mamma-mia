            ...
            <main className="container">
                <section className="row">
                    <CardPizza
                        name="Napolitana"
                        price={5950}
                        ingredients={["mozzarella", "tomates", "jamón", "orégano"]} img="https://firebasestorage.googleapis.com/v0/b/apis-varias-mias.appspot.co
...
ac54-90f6c31eb3e3"
                    ...
                    <Card key={index} title={card.title} company={card.company} address={card.address} listPrice={card.listPrice} sellingPrice={card.sellingPrice} image={card.image} />
                )} */}
                </section>
            </main>
